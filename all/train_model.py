...
window = tk.Tk()
window.title("Face Recognition by Thenish Reddy(19bce1019),VIT, CHENNAI")
...
def take_img():
    ...
    detector = cv2.CascadeClassifier(r'C:\Users\Admin\Desktop\Face-Recognizer_UsingLBPH-CSE(4019)\haarcascade_frontalface_default.xml')
    ID = txt.get()
    Name = txt2.get()
    sampleNum = 0
    while (True):
...
def trainimg():
    ...
    try:
        recognizer.save(r"C:\Users\Admin\Desktop\Face-Recognizer_UsingLBPH-CSE(4019)\model\trained_model2.yml")
    except Exception as e:
...
message = tk.Label(window, text="Image_processing_CSE4019_Jcomponent", bg="cyan", fg="black", width=50,
